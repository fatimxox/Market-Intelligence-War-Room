...
import { Calendar, ArrowLeft, ChevronRight } from '../../src/components/icons.tsx';
        ...
        <div className="w-full relative" ref={pickerRef}>
            ...
            <div className="relative flex items-center">
                 <input
                    ...
                    className="w-full bg-background border border-panel-border rounded-md py-2 px-3 text-primary-text placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition cursor-pointer"
                />
